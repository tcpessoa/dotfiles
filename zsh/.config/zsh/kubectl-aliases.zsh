# kubectl aliases + helpers — extracted from the oh-my-zsh kubectl plugin
# (completion is wired separately via ~/.cache/zsh/comp-kubectl.zsh)
# Regenerate from a newer OMZ copy if needed; otherwise self-contained.
