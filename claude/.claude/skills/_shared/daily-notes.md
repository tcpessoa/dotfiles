...
<!-- AI:START -->
## 🤖 AI Generated
*Last updated: YYYY-MM-DD HH:MM by /reconcile*
...
If you ran twice in a session (e.g., user said `go`, then ran `/reconcile` again ten minutes later), re-reading the AI block tells you what's already recorded. Don't duplicate `Tracker activity` entries — only add new ones since the last block update.
